...
This document has been derived from the instructions made by the NAACL-HLT 2009 publications chairs (Eric Ringger and Christy Doran), and then adapted to the START integration of the ACLPUB scripts, and then updated to reflect changes in START/ACLPUB scripts by Margaret Mitchell, 2017.
