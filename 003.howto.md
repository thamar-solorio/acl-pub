...
<div style="background:#ddd;border:1px solid #999;color:#000;font:13px arial,sans-serif;font-weight:normal;margin:12px;padding:8px;text-align:left">This is Google's cache of [http://nlp.csie.ncnu.edu.tw/~shin/acl2010/publication/howto/aclpub/ACLPUB.START.2.htm](http://nlp.csie.ncnu.edu.tw/~shin/acl2010/publication/howto/aclpub/ACLPUB.START.2.htm). It is a snapshot of the page as it appeared on 19 May 2014 10:54:01 GMT. The [current page](http://nlp.csie.ncnu.edu.tw/~shin/acl2010/publication/howto/aclpub/ACLPUB.START.2.htm) could have changed in the meantime. [Learn more](http://support.google.com/websearch/bin/answer.py?hl=en&p=cached&answer=1687222)
Tip: To quickly find your search term on this page, press **Ctrl+F** or **⌘-F** (Mac) and use the find bar.

<div style="float:right">[Text-only version](http://webcache.googleusercontent.com/search?q=cache:nlp.csie.ncnu.edu.tw/~shin/acl2010/publication/howto/aclpub/ACLPUB.START.2.htm&strip=1)</div>
...
This document has been derived from the instructions made by the NAACL-HLT 2009 publications chairs (Eric Ringger and Christy Doran), and then adapted to the START integration of the ACLPUB scripts.`</div>