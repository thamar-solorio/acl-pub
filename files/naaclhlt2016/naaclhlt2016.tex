...
However, you should maintain space for names and addresses so that they will fit in the final (accepted) version.  The NAACL HLT 2016 style will create a titlebox space of 2.5in for you when \verb|\naaclfinalcopy| is not specified.  
