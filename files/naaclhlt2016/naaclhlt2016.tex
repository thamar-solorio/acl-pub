...
\begin{abstract}
 ...
 document, it will compile to produce an example of the camera-ready formatting. 
\end{abstract}
...
However, you should maintain space for names and addresses so that they will fit in the final (accepted) version.  The NAACL HLT 2016 style will create the space for you when \verb|\naaclfinalcopy| is not specified.
...
\verb|\esp| & \esp\\\hline
\end{tabular}
\caption{Shorthand commands provided in the NAACL HLT style.}\label{tab:shorthand}
\end{table}

{\bf Text}: Begin typing the main body of the text immediately after
the abstract, observing the two-column format as shown in 
the present document.  Do not include page numbers.  NAACL HLT 2016
additionally provides some helpful text macros, shown in Table \ref{tab:shorthand}.
...
authors rather than initials is preferred.  If preferred, you may use
abbreviations for conferences\footnote{\scriptsize {\tt https://en.wikipedia.org/wiki/ \\ \-\hspace{.75cm} List\_of\_computer\_science\_conference\_acronyms}} and journals\footnote{\tt http://www.abbreviations.com/jas.php}.
