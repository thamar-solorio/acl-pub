...
\title{Instructions for NAACL HLT 2016 Proceedings\Thanks{This
    ...
    NAACL-HLT-15 by Matt Post and Adam Lopez,
...
\begin{abstract}
 This document contains the instructions for preparing NAACL HLT 2016 submissions and camera-ready
  ...
  all the directions reported in this document.  Submitted and camera-ready formatting is similar,
  however, the submitted paper should have author-identifying information removed, a `ruler' on the left
 and right margins, page numbers, and a confidentiality header.  By uncommenting \verb|\naaclfinalcopy| at the top of this 
 document, it will compile to produce an example of the camera-ready formatting; by leaving it commented out, the document will be anonymized for initial submission.  When you first create your submission on softconf, please fill in your submitted paper ID in the \verb|\def\naaclpaperid{***}| definition at the top.
\end{abstract}
...
maximum number of pages).  Do not number the pages in the camera-ready
manuscript.

By uncommenting \verb|\naaclfinalcopy| at the top of this 
 document, it will compile to produce an example of the camera-ready formatting; by leaving it commented out, the document will be anonymized for initial submission.  When you first create your submission on softconf, please fill in your submitted paper ID where \verb|***| appears in the \verb|\def\naaclpaperid{***}| definition at the top.
...
However, you should maintain space for names and addresses so that they will fit in the final (accepted) version.  The NAACL HLT 2016 \LaTeX\ style will create a titlebox space of 2.5in for you when \verb|\naaclfinalcopy| is commented out.  
...
references (\eg the first line on this page is $096.5$), although in most cases one would
expect that the approximate location will be adequate.

\subsection{Electronically-available resources}

NAACL HLT provides this description in \LaTeX2e{} ({\tt naaclhlt2016.tex}) and PDF
format ({\tt naaclhlt2016.pdf}), along with the \LaTeX2e{} style file used to
format it ({\tt naaclhlt2016.sty}) and an ACL bibliography style ({\tt naaclhlt2016.bst}).
These files are all available at
{\tt naacl.org/naacl-hlt-2016}.  A Microsoft Word
template file ({\tt naaclhlt2016.dot}) is also available at the same URL. We
...
in all capitals (\eg ``Mitchell,'' not ``MITCHELL'').  The affiliation should
...
\begin{tabular}{|l|l|}
\hline
{\bf Command}& {\bf Rendered text} \\\hline
\verb|\eg| & \eg \\
\verb|\ie| & \ie\\
\verb|\cf| & \cf\\
\verb|\etc| & \etc\\
...
\verb|\esp| & \esp\\\hline
\end{tabular}
\caption{Shorthand commands provided in the NAACL-HLT \LaTeX\ style.}\label{tab:shorthand}
\end{table}

{\bf Text}: Begin typing the main body of the text immediately after
the abstract, observing the two-column format as shown in 
the present document.  Do not include page numbers in the camera-ready manuscript.  
The NAACL HLT 2016 \LaTeX\ style additionally provides some helpful text macros, shown in Table \ref{tab:shorthand}. 
MS Word users may desire to user similar formatting.
...
Psychological Association\/}~\cite{APA:83}.  Full names for
authors rather than initials is preferred.  You may use
...
abstract text & 10 pt & \\
captions & 10 pt & \\
caption label & 10 pt & bold \\
above caption skip & 3 pt & \\
bibliography & 10 pt & \\
footnotes & 9 pt & \\
\hline
\end{tabular}
...
tables below the body, using 10 point text.  Table and Figure labels should be bold-faced.
...
reveal the author's identity, \eg ``We previously showed (Smith,
