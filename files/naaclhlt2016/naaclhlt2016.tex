...
\usepackage{times}
\usepackage{latexsym}
% Adding line numbers for submitted versions -- M. Mitchell
...
{\tt http://naacl2016.naacl.org}.  A Microsoft Word
...
tables below the body, using 10 point text.  Table and Figure prefixes should be bold-faced.
