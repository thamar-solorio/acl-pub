...
This is where you edit most of the front matter and online information for the proceedings.
                    ...
                    | Files Edited                                                    
 ------------------ | ---------------------------------------------------------------- 
 Tex Files:         | `titlepage.tex`, `copyright.tex`, `preface.tex`,  `organizers.tex`, `citation-stamp.tex`, `spine.tex`, `book.tex` 
 Header Files:      | `toc.tex.head`, `program.tex.head`, `cd.tex.head`                 
 HTML Header Files: | `index.html.head`, `authors.html.head`, `program.html.head`, `unified-authors.html.head` , `mainindex.html.head`

Pressing the buttons in this table will also generate:
<dl>
  <dt>Book Proceedings Files</dt>
  <dd> `program.tex`, `toc.tex`, `program.html`, `int.html`</dd>

  <dt>Online Proceedings Files</dt>
