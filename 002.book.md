...
`program.tex` will follow what is given in the `order` file ([Step 4](#step-4--order-tab)).  You edit/customize `program.tex` in [the Program Tab (Step 5)](#step-5--the-program-tab), and you can edit/customize `toc.tex` in [the TOC Tab (Step 8)](#step-8--toc-tab).  For editing/customizing the HTML, you'll need to do it offline.
...
2. After you've uploaded, generate `All`, under the **Generate** tab, without any errors.  See the [Step 9:  Generate! Tab](#step-8--generate-tab-trophy-trophy) section for more.
...
The Bibtex url should be put in place in [Step 6:  Online Proceedings Tab (CDROM)](#step-5--cdrom-tab-online-proceedings-tab), to aid generation of the online proceedings.

### Logos  

Sponsors for your workshop/conference should have their logos appear on the `copyright.tex` page.  [Jump to Step 3](#step-2--dwnl-templates-tab) to make sure those are uploaded and included.
