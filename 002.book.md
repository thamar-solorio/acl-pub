...
To see the current margins for each paper in the table:  In the left column, click on the rightmost `Edit Submission`.  This is circled in red image right.  This will bring you to the authors' final uploaded paper, where you can take a look at how well the margins fit, and adjust accordingly.
