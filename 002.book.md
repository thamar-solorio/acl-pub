...
**Copyright Page**
  ...
  You will have to fill out the ISBN.  This can be found in the Google spreadsheet.  This is also where to use the \includegraphics tex call for sponsor logos. 
