...
audience: This page is for conference organizers (main conference, workshop & demo chairs) who need to put together a book for inclusion in the ACL proceedings.
---
...
3. [Instructions](#instructions)
   ...
   [Step 1: Generate Tab](#step-1--generate-tab)
   ...
   [Step 6:  Online Proceedings Tab (CDROM)](#step-6--cdrom-tab-online-proceedings-tab)
...
[1: Initial Generation](step-1--generate-tab) &middot; [2: Margins](#step-2--margins-tab) &middot; [3: Dwnl Templates](#step-3--dwnl-templates-tab) &middot;  [4: Order](#step-4--order-tab) [5: Templates](#step-5--templates-tab)  &middot; [6: Online Proceedings (CDROM)](#step-6--cdrom-tab-online-proceedings-tab)  &middot;  [7: Program](#step-7--program-tab)  &middot; [8: TOC](#step-8--toc-tab)  &middot; [9: Generate!](#step-9--generate--trophy-trophy)
...
The `cdrom` directory in the full compiled proceedings can be used to create the Online Proceedings, with the program (`program.html`), authors (`authors.html`), and home page (`index.html`).  These are built with the proceedings generator using the Headers content exposed in [Step 5: Templates](#step-5--templates-tab).
