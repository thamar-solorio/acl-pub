...
4. Now you should be in the `ACLPUB Proceedings Generator`.

> ![alt text](howto_images/start_tabs.png "Left to Right START Tabs.")

5. This Proceedings Generator creates two things:
   1.  An online proceedings
   2.  A latex-based *book* proceedings

6. Compiling the book proceedings uses the following files:
  1. titlepage.tex
  2. copyright.tex
  3. preface.tex
  4. organizers.tex
...
| Margins            | Margins                                 | |
| Order              | Schedule & Author Ordering              | `program.tex`, `order` |
| CDROM              | THE MOST IMPORTANT TAB                  | |
| Program            | Proceedings Program and Table of Contents     | program.tex, toc.tex |
| Toc                | toc.tex, again                          | |
| Generate           | Compile full proceedings                | |
...
### Templates
 ...
 ##### Copyright Page
  Exposes [this copyright.tex form](files/copyright.tex) 
  - Located under Templates → copyright.tex
  - You will have to fill out the ISBN
  -- can be found in the Google spreadsheet
  - This is also where to use the \includegraphics tex call for sponsor logos


### Dwnl Templates
 ![alt text](howto_images/dwnl_templates.png "The Download/Upload Tab.")
 
 back.tex, book.tex, citation-stamp.tex, copyright.tex, organizers.tex, preface.tex, titlepage.tex

### Margins
 ![alt text](howto_images/margins.png "The Margins Tab.")

### Order
 ![alt text](howto_images/order.png "The Order Tab.")

This is where the Schedule ordering and Proceedings ordering are defined.
They both use one file, called `order`

* To Arrange the Schedule Ordering:
 * Takes you to the Schedule Maker, pub/scmd.cgi?scmd=scheduleMaker2
 
* To Arrange the Proceedings Ordering:
 * Use the `order` file
...
### CDROM 
 ![alt text](howto_images/cdrom.png "The CDROM Tab.")
