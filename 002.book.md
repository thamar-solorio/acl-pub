...
2. Click on each tab, left to right, and do what it says, top-down.
  1. ![alt text](howto_images/start_tabs.png "Left to Right START Tabs.")
3. Your goal is to get to the last step, Generate "All", under the "Generate" tab, without any errors.
  1.  ![alt text](howto_images/aclpub_goal.png "Image of last Generate tab view, with 'All' button producing successful proceedings.")
