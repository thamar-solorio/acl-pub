...
3. [Instructions](#instructions)
   ...
   [Step One:  Margins Tab](#margins)

   [Step Two:  Dwnl Templates Tab](#dwnl-templates)

   [Step Three:  Order Tab](#order)
   
   [Step Four:  Templates Tab](#templates)

   [Step Five:  Online Proceedings Tab (CDROM)](#cdrom)
   
   [Step Six:  Program](#program)
   
   [Step Seven:  Toc](#toc)
   
   [Step Eight:  Generate!](#generate)
...
5. This Proceedings Generator creates two things:
   1.  An online proceedings, based in html
   2.  A book proceedings, based in latex

6. Compiling the book proceedings end-to-end will also produce the online proceedings.

7. To compile the book proceedings, we use the ACLPUB Proceedings Generator and the following `.tex` files:
  1. `titlepage.tex`
  2. `copyright.tex`
  3. `preface.tex`
  4. `organizers.tex`
  ...
  6. `program.tex`
  7. `spine.tex`
  9. `citation-stamp.tex`
  10. `copyright-signatures`

8. We edit those files in the Proceedings Generator using the following tabs:
...
Use this tab to correct the margins on your papers.
...
### Step Six:  Program (may be able to skip)
 ![alt text](howto_images/program.png "The Program Tab.")

### Step Seven:  Toc (may be able to skip)
