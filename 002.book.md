...
You can find those here, in [this ACL 2017 Workshops google doc](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing), once you have verified your workshop name.  ISBNs are assigned based on the precise name of your workshop, so make sure your workshop name is finalized.
...
When you are done, zip the edited directory back up again, and click the ACLPUB templates zip name `Choose File` button to upload it.
