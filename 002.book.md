...
heading, following the `ACLPUB` link. Instructions on book assembly 
can be found under the Instructions tab, which uses the
[ACLPUB HOWTO here](aclpub-howto-2017.html), and that we sumarize below.
