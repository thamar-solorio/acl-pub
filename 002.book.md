...
4. Download the ACLPUB zipfile in the `Dwnl Templates` tab, edit those files directly, re-zip, and upload.

   <kbd>
   ![alt text](howto_images/dwnl_templates.png "The Download/Upload Tab.")
   </kbd>

5. Generate `All`, under the `Generate` tab, without any errors.
