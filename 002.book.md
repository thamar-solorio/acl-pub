...
1. Your Softconf workshop abbreviation ${WSAbbreviation} is [on this spreadsheet, under "Softconf"](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing).
...
4. Your goal is to get to the last step, Generate `All`, under the **Generate** tab, without any errors.
