...
3. Expert Route:  Download the ACLPUB zipfile in the **Dwnl Templates** tab, edit those files directly and perfectly, re-zip, and upload.

   <kbd>
   ![alt text](howto_images/dwnl_templates.png "The Download/Upload Tab.")
   </kbd>

4. Generate `All`, under the **Generate** tab, without any errors.  It has to look good and abide by the ACL paper and style guidelines. It's up to you to make sure it does.
