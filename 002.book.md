...
1. Go to your workshop's softconf website:  https://www.softconf.com/acl2017/${WSAbbreviation}, where ${WSAbbreviation} is your workshop abbreviation on softconf.

2. Go to the Publication Console (/pub):  https://www.softconf.com/acl2017/${WSAbbreviation}/pub
...
|                    | Files Edited                                                    | Files Generated |
| ------------------------------------------------------------------------------------ | --------------- |
| Tex Files:         | `titlepage.tex`, `copyright.tex`, `preface.tex`,                | `program.tex`   |
|                    | `organizers.tex`, `citation-stamp.tex`, `spine.tex`, `book.tex` |   `toc.tex`     |
| ------------------ | --------------------------------------------------------------- | --------------- |
| Header Files:      | `toc.tex.head`, `program.tex.head`, `cd.tex.head`               |                 |
| ------------------ | --------------------------------------------------------------- | --------------- |
| HTML Header Files: | `index.html.head`, `authors.html.head`, `program.html.head`,    |                 |
|                    | `unified-authors.html.head` , `mainindex.html.head`             |                 |
