...
Once downloaded and unzipped, **you can edit all `tex` files here directly**.  You also add sponsorship logos here, via `\includegraphics` and \graphicspath{{./}{../templates/}{../}}, and referencing the images added to the directory.
