...
<dl>
  ...
  <dd>
      ...
      <dd>`titlepage.tex`, `copyright.tex`, `preface.tex`,  `organizers.tex` (Sections Subtab) </dd>
      <dd> `citation-stamp.tex`, `spine.tex`, `book.tex` (Settings Subtab)</dd>
      <dd>`toc.tex.head`, `program.tex.head` (Headers Subtab)</dd>
      <dt>Online Proceedings</dt>
      <dd>`index.html.head`, `authors.html.head`, `program.html.head`, `unified-authors.html.head` , `mainindex.html.head` (CDROM Subtab)</dd>
      </dl>
  </dd>
