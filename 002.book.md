...
1. Download the ACLPUB zipfile in the **Dwnl Templates** tab, edit those files directly and perfectly, re-zip, and upload.  

2. Download the CDROM zipfile in the **Dwnl Templates** tab, edit those files directly and perfectly, re-zip, and upload.  

See the [Dwnl Templates](#step-2--dwnl-templates-tab) section for more.

   <kbd>
   ![alt text](howto_images/dwnl_templates.png "The Download/Upload Tab.")
   </kbd>

3. Generate `All`, under the **Generate** tab, without any errors.  See the [Step 8:  Generate! Tab](#step-8--generate-tab-trophy-trophy) section for more.
