...
3. [Instructions](#instructions)
   ...
   [Table 1:  Files used in Book Proceedings Generation](#table-one-files-used-in-book-proceedings-generation)

   [Table 2:  Files used in Online Proceedings Generation](#table-two-files-used-in-online-proceedings-generation)
   
   [Table 3:  Softconf ACLPUB Proceedings Generation Tabs](#table-three-softconf-aclpub-proceedings-generation-tabs)

   [Step 1:  Margins Tab](#step-one--margins-tab)

   [Step 2:  Dwnl Templates Tab](#step-two--dwnl-templates-tab)

   [Step 3:  Order Tab](#step-three--order-tab)
   
   [Step 4:  Templates Tab](#step-four--templates-tab)

   [Step 5:  Online Proceedings Tab (CDROM)](#step-five--cdrom-tab-online-proceedings-tab)
   
   [Step 6:  Program Tab](#step-six--program-tab)
   
   [Step 7:  Toc Tab](#step-seven--toc-tab)
   
   [Step 8:  Generate! Tab](#step-eight--generate-tab)
...
__*If you'd prefer to edit files directly (Expert Route), just go to [Step 2:  Dwnl Templates Tab](#step-two--dwnl-templates-tab), upload when you're done, then go to [Step 8:  Generate! Tab](#step-eight--generate-tab).*__
...
###  **Table 3.  The tabs in the Sofctonf ACLPub Proceedings Generation.**
...
**Copyright Page**
  ...
  This is also where to use the \includegraphics tex call for sponsor logos, which we uploaded in [Step Two](#step-two--dwnl-templates-tab).
...
### Step Six:  Program Tab
 ...
 ![alt text](howto_images/program.png "The Program Tab.")
   ...
   Customize your book proceedings Program `program.tex` here.  This is generated automatically in the Templates tab, when you click `Program`.  See [Step Four](#step-four--templates-tab).
...
### Step Seven:  Toc Tab
 ...
 ![alt text](howto_images/toc.png "The Table of Contents Tab.")
    ...
    Customize your toc.tex here.  This is generated automatically in the Templates Tab, when you click `Toc`.  See [Step Four](#step-four--templates-tab).
...
![alt text](howto_images/generate.png "The Generate Tab.") </kbd>
   ...
   Once you can compile `All` without errors, you are done!
   
## Expert Route

1. Download the ACLPUB zipfile in the **Dwnl Templates** tab, edit those files directly and perfectly, re-zip, and upload.  See the [Dwnl Templates](#step-two--dwnl-templates-tab) section for more.

   <kbd>
   ![alt text](howto_images/dwnl_templates.png "The Download/Upload Tab.")
   </kbd>

2. Generate `All`, under the **Generate** tab, without any errors.  See the [Step 8:  Generate! Tab](#step-eight--generate-tab) section for more.
