...
6. [Camera-ready FAQ](camera-ready-faq.md)
...
### Important Details
1. Your Softconf workshop abbreviation is [on this spreadsheet, under "Softconf"](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing).

2. Check [that spreadsheet](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing) to make sure your workshop name is the **precise name** of the workshop, in order to get the ISBN.

3.  Based on the finalized workshop name, we will [update the spreadsheet to give you your ISBN](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing). 
...
You can find those [in the ACL 2017 Workshops google doc](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing), once you have verified your workshop name.  ISBNs are assigned based on the name of your workshop, so make sure your name is good. 
...
To get to the Softconf ACL Proceedings Generator: 
 - Go to your workshop's softconf website:  https://www.softconf.com/acl2017/${WSAbbreviation}, where ${WSAbbreviation} is your [Softconf workshop abbreviation](https://docs.google.com/spreadsheets/d/1x1RtUjAy-S_YhvTXWTrUc5xs9_4HkF0pOGynhRE963M/edit?usp=sharing).
...
This is your chance to go paper by paper and check out if each is okay for the proceedings.  
...
For each paper, go to the left column and click on the rightmost `Edit Submission`.  This is circled in red image left :arrow_left:.  This will bring you to the authors' final uploaded paper, where you can take a look at the paper.

<kbd>![alt text](howto_images/margins.png "The Margins Tab.")</kbd>

For each, check out:  Are the authors correct?  Is their contact information easily findable?  Is there a large error or issue in how figures and tables show up?

If there is an issue, contact the authors and get the new version uploaded.

This is also the time to correct the margins on the papers in the proceedings.  

Look especially at page 2 of each paper. If the text doesn't fit within the frame, look at the top of the text to see how many millimeters it should be moved.


### All papers at once (only possible to do in [the last stages of the process](#step-8--generate-tab-trophy-trophy))
You can create a ["rough cut" of the full book](#rough-cut) in the `Generate` tab, which will show you rulers on all of the papers in one pdf.  

You can change margins back in this tab by clicking on the cell all the way to the right -- this will bring up the Margins adjustment, circled in red image right :arrow_right:. 
...
The top/bottom margins of the paper are often wrong, so the rough-cut version of `book.pdf` includes a margin frame and rulers that should make it easy to detect how much each paper must be shifted to fit. Each paper is also stamped with its submission ID.

Look especially at page 2 of each paper. If the text doesn't fit within the frame, look at the top of the text to see how many millimeters it should be moved, and add a margin specification in the Margins tab, as in [Step 1](#step-1--margins-tab).
...
1. Download the ACLPUB and CDROM zipfiles in the **Dwnl Templates** tab, [download the compilation scripts here](assets/files/create_book), edit the files and compile all the things perfectly, re-zip, and upload.  See the [Dwnl Templates](#step-2--dwnl-templates-tab) section for more.
...
![](images/aclpub_howto.png)
  
2. After you've uploaded, generate `All`, under the **Generate** tab, without any errors.  See the [Step 8:  Generate! Tab](#step-8--generate-tab-trophy-trophy) section for more.
...
1. *Margins*. Papers should fit entirely within the margins prescribed by the
   conference booklet.   See [Step 1: Margins above.](#step-1--margins-tab)
...
The Bibtex url should be put in place in [Step 5:  Online Proceedings Tab (CDROM)](#step-5--cdrom-tab-online-proceedings-tab), to aid generation of the online proceedings.

### Logos  

Sponsors for your workshop/conference should have their logos appear on the `copyright.tex` page.  [Jump to Step 2](#step-2--dwnl-templates-tab) to make sure those are uploaded and included.

## Camera-Ready FAQ

See [camera-ready-faq.md](camera-read-faq.md)
## Authors
